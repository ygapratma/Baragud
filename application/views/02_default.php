												...
												<div class="menu-item px-3">
													<div class="menu-content d-flex align-items-center px-3">
														...
														<div class="d-flex flex-column">
															<div class="fw-bolder d-flex align-items-center fs-5">Vendor Name
															<span class="badge badge-light-success fw-bolder fs-8 px-2 py-1 ms-2"> ID </span></div>
															<a class="fw-bold text-muted text-hover-primary fs-7">Vemdor E-mail</a>
														</div>
														<!--end::Username-->
													</div>
												</div>
